...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『NinjaBot』", true)
      
      .addField("『@مصصم البوت』 『❤️ @vrgo3gamer/فرجوع جيمر#3235 ❤️』", true)
...
👑^^bc 『برودكاست /لعمل رسالة اعلانية لكل الاعضاء خاص』 🆕
...
القسم الثالث مصمم البوت | @vrgo3gamer/فرجوع جيمر#3235
...
if(message.content.split(' ')[0] == prefix + 'bc') {
    if (!args[1]) {
message.channel.send("**^^bc <رسالتك>**");
return;
}
...
client.on('ready', () => {
   client.user.setGame(`^^help | ^^invite `,'https://www.twitch.tv/Vrgo3gamer');
}); 
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=447528028697001984&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
client.login('NDQ3NTI4MDI4Njk3MDAxOTg0.DeJrCA.nYpqaSbp8_V0ixe2mlMqohUYXS4');
